...
s.write(xml="new.xml")
```
N.B. this aspect of the code is not well developed as of Dec. 2025, i.e. no default attributes are created as you would expect with an empty slot, blank shot, etc.
